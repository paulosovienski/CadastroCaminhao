...
{
    public class CaminhaoTesteController : Controller
    {
        private readonly CaminhaoContext _context;

        public CaminhaoTesteController(CaminhaoContext context)
        {
            _context = context;
        }
        ...
        // GET: CaminhaoTeste/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: CaminhaoTeste/Create
